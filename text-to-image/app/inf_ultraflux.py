...
def generate_images(pipe, prompts: List[str], height: int = 4096, width: int = 4096, guidance_scale: float = 4, num_inference_steps: int = 50, max_sequence_length: int = 512, seed: int = 0):
